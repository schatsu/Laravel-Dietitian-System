...
{{--        </div>--}}
        <div class="row justify-content-center align-items-center pt-2">
            ...
            <!-- end divider -->
            <!-- start copyright -->
            <div class="col-lg-5 pt-35px pb-35px md-pt-0 order-2 order-lg-1 text-center text-lg-start last-paragraph-no-margin"><p>&copy; {{date('Y')}} Powered by <a href="https://www.tufiworks.com/" @safeBlank class="text-dark-gray fw-600 text-decoration-line-bottom">tufiworks</a></p></div>
            <!-- end copyright -->
            <!-- start footer menu -->
